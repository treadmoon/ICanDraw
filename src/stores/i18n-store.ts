...
const dict = {
  zh: {
    ...
    analyzingRepo: "正在解析仓库...",
    parsingCode: "正在解析代码结构...",
    generatingDiagrams: "正在生成图表...",
    repoAnalysis: "仓库分析",
    githubUrlHint: "粘贴 GitHub 仓库地址",
    analyzeProject: "分析项目",
    analysisError: "分析失败",
    overview: "项目概览",
    techStack: "技术栈",
    projectType: "项目类型",
    keyFeatures: "关键特性",
    diagramsGenerated: (count: number) => `已生成 ${count} 个图表`,
    suggestion4: "分析 https://github.com/facebook/react",
  },
  en: {
    appTitle: "ICanDraw",
    ...
    parsingCode: "Parsing code structure...",
    generatingDiagrams: "Generating diagrams...",
    repoAnalysis: "Repository Analysis",
    githubUrlHint: "Paste a GitHub repo URL",
    ...
    diagramsGenerated: (count: number) => `Generated ${count} diagrams`,
    suggestion4: "Analyze https://github.com/facebook/react",
  },
} as const;
