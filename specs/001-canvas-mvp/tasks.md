...
- [x] T001 Initialize Next.js project with TypeScript, Tailwind CSS, App Router
- [x] T002 [P] Install dependencies: @excalidraw/excalidraw, echarts, ai, zustand, zod, papaparse
- [x] T003 [P] Configure TypeScript strict mode, ESLint, Prettier
- [x] T004 Create shared TypeScript types in `src/types/index.ts`

---

## Phase 2: Foundational (Blocking)

- [x] T005 Create Zustand canvas store (`src/stores/canvas-store.ts`) — charts array, annotations array, CRUD actions
...
- [x] T017 Extend AI schema and prompts to include annotation generation (arrows, text, circles)
- [x] T018 Create canvas-utils (`src/lib/canvas-utils.ts`) — position calculation for annotations relative to chart bounds
- [x] T019 Update Canvas component to inject AI-generated Excalidraw elements into the Excalidraw scene
- [x] T020 Update chat flow to merge both charts and annotations into canvas store on AI response
...
- [x] T021 Update chat store to build conversation context including current canvas state summary
- [x] T022 Update AI prompts to support modification instructions (change chart type, update style, modify data)
- [x] T023 Implement canvas store merge logic — AI returns partial update, store patches existing charts/annotations
- [x] T024 Handle chart replacement (e.g., bar → pie) while preserving position and data
